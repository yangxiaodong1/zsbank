...
public class BjbankKeyCache implements Load {
	private final static Logger cLogger = Logger.getLogger(BjbankKeyCache.class);
	
	private static BjbankKeyCache cThisIns = new BjbankKeyCache();
	...
	private String cPath = "key/bjbankKey.dat";
	
	private BjbankKeyCache() {
		load();
	...
	public static BjbankKeyCache newInstance() {
		return cThisIns;
	}
