...
/**
 * @Title: com.sinosoft.midplat.cebbank.format.NewContOutXsl50002.java
 * @Description: 负责加载核心标准报文转换为非标准报文模板--组合产品50002
 * Copyright: Copyright (c) 2014
 * Company:安邦保险IT部
 * 
 * @date Jan 22, 2014 5:20:46 PM
 * @version 
 *
 */
public class NewContOutXsl50002 extends XslCache{
	...
	private String cPath = "com/sinosoft/midplat/cebbank/format/NewContOut50002.xsl";
