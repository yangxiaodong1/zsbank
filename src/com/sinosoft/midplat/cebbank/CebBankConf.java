...
public class CebBankConf extends XmlConf {
	private static final CebBankConf cThisIns = new CebBankConf();
	
	private static final String cPath = "conf/cebbank.xml";
	...
	public void load() {
		cLogger.info("Into CebBankConf.load()...");
		...
		cLogger.info("Out CebBankConf.load()!");
	}
	
	public static CebBankConf newInstance() {
		return cThisIns;
	}
}
