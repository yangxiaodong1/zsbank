 ...
 * 查询保单状态
 */
public class CebBankProposalStatusQuery extends UploadFileBatchService {

	private RecordPacker packer = new FixedDelimiterPacker("\\|", '|');

	private String inQueryDate = "";
	
	public CebBankProposalStatusQuery() {
		super(CebBankConf.newInstance(), "908");
	}
	...
	protected void setBody(Element bodyEle) throws Exception {
		...
		String readFileName = "CEB10" + "TB01"
	...
	protected void bakFiles(String fileDir) {
		cLogger.info("Into CebBankProposalStatusQuery.bakFiles()...");
		...
		cLogger.info("Out CebBankProposalStatusQuery.bakFiles()!");
	}
	...
	protected String getFileName() {
		// Element mBankEle = thisRootConf.getChild("bank");
		return "CEB10" + "RETB" + DateUtil.getDateStr(calendar, "yyyyMMdd")
				+ ".txt";
	}
