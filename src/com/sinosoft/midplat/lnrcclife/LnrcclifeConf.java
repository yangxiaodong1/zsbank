 ...
 * @date   Mar 25, 2016
 */
public class LnrcclifeConf extends XmlConf {

	private static final LnrcclifeConf cThisIns = new LnrcclifeConf();

	private static final String cPath = "conf/lnrcclife.xml";
	
	public LnrcclifeConf(){
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into LnrcclifeConf.load()...");
		...
		cLogger.info("Out LnrcclifeConf.load()!");
	}
	
	public static LnrcclifeConf newInstance() {
		return cThisIns;
	}
