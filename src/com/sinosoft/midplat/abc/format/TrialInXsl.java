...
public class TrialInXsl extends XslCache {
	private static TrialInXsl cThisIns = new TrialInXsl();

	private String cPath = "com/sinosoft/midplat/abc/format/TrialIn.xsl";
	...
	public void load() {
		cLogger.info("Into TrialInXsl.load()...");
		...
		cLogger.info("Out TrialInXsl.load()!");
	}

	public static TrialInXsl newInstance() {
		return cThisIns;
	}
}
