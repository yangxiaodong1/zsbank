...
public class JlyhConf extends XmlConf{

	private static final JlyhConf cThisIns = new JlyhConf();
	private static final String cPath = "conf/jlyh.xml";
	...
	public void load() {
		...
		cLogger.info("Into JlyhConf.load()...");
		...
		cLogger.info("Out JlyhConf.load()!");
	}
	
	public static JlyhConf newInstance() {
		return cThisIns;
	}
}
