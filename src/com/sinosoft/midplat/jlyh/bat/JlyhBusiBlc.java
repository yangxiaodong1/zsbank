...
public class JlyhBusiBlc extends Balance {

	public JlyhBusiBlc() {
		super(JlyhConf.newInstance(), "1804");
	}
	...
	/**
	 *对账文件名：JLYH+日期+01.txt（例如：JLYH2012120101.txt）
	 *日期后面两位固定为"01"代表新单对账类型。
	 */
	protected String getFileName() {
		return "JLYH"+DateUtil.getDateStr(cTranDate, "yyyyMMdd")+"01.txt";
	}
	
	protected Element parse(InputStream pBatIs) throws Exception {
		
		cLogger.info("Into JlyhBusiBlc.parse()...");
		...
		cLogger.info("Out JlyhBusiBlc.parse()!");
		return mBodyEle;
	}
