...
/**   
 * @Title: NewContInXsl.java 
 * @Package com.sinosoft.midplat.jsbc.format 
 * @Description: 加载江苏银行新单试算报文转换文件；银行-->核心 
 * @date Apr 23, 2015 2:33:37 PM 
 * @version V1.0   
 */
...
public class NewContInXsl extends XslCache {
	...
	private String cPath = "com/sinosoft/midplat/jsbc/format/NewContIn.xsl";
