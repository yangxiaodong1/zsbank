...
public class JxnxsConf extends XmlConf {
	private static final JxnxsConf cThisIns = new JxnxsConf();

	private static final String cPath = "conf/jxnxs.xml";
	...
	public static JxnxsConf newInstance() {
		return cThisIns;
	}
}
