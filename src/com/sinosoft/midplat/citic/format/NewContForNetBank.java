...
public class NewContForNetBank extends XmlSimpFormat {
	...
	public Document noStd2Std(Document pNoStdXml) throws Exception {
      ...
      //获取机构代码
		...
		mStdXml = NewContForNetBankInXsl.newInstance().getCache().transform(pNoStdXml);
		cLogger.info("CITIC_中信银行，NewContForNetBankInXsl进行报文转换，主险riskCode=[" + mainRiskCode + "]");
		
		//add 20160712 PBKINSR-1283 中信-网银-盛世3号产品需求 begin
        ...
        //add 20160712 PBKINSR-1283 中信-网银-盛世3号产品需求 end
		
		//add 20160720 PBKINSR-1390  中信济南分行专属产品需求
