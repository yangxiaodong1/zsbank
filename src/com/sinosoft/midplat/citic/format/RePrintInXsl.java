...
/**
 * @Title: com.sinosoft.midplat.citic.format.RePrintInXsl.java
 * @Description: 中信银行，将银行请求报文转换为我方接收的标准报文
 * Copyright: Copyright (c) 2013 
 * Company:安邦保险IT部
 * 
 * @date Aug 16, 2013 1:42:47 PM
 * @version 
 *
 */
public class RePrintInXsl extends XslCache {
	...
	private String cPath = "com/sinosoft/midplat/citic/format/RePrintIn.xsl";
