...
/**
 * @Title: com.sinosoft.midplat.citic.format.CancelInXsl.java
 * @Description: 中信银行，将银行请求报文转化为我方的报文
 * Copyright: Copyright (c) 2013 
 * Company:安邦保险IT部
 * 
 * @date Aug 15, 2013 5:32:59 PM
 * @version 
 *
 */
public class CancelInXsl extends XslCache {
	...
	private String cPath = "com/sinosoft/midplat/citic/format/CancelIn.xsl";
