...
public class NoRealTimeUWResultOutXsl extends XslCache {
	...
	private String cPath = "com/sinosoft/midplat/citic/format/NoRealTimeUWResultOut.xsl";
	...
	public void load() {
		...
		cLogger.info("Into NoRealTimeUWResultOutXsl.load()...");
		...
		cLogger.info("Out NoRealTimeUWResultOutXsl.load()!");
	}
