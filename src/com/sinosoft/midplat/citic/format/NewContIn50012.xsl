...
<xsl:variable name="PayEndYearFlag">Y</xsl:variable>
<!-- 
<xsl:variable name="PayEndYearFlag"><xsl:apply-templates select="PbInsuYearFlag" /></xsl:variable>
 -->
...
<!-- 组合产品份数 -->
<xsl:variable name="PubMult"><xsl:value-of select="PbSlipNumb" /></xsl:variable>
<!-- 险种,此处是产品组合编码 -->
...
<ContPlan>
	<!-- 产品组合编码 -->
	<ContPlanCode><xsl:value-of select="$MainRiskCode" /></ContPlanCode>
	<!-- 产品组合份数 -->
	<ContPlanMult><xsl:value-of select="$PubMult" /></ContPlanMult>
</ContPlan>
...
<Risk>	<!-- 主险 -->
	...
	<Mult><xsl:value-of select="$PubMult" /></Mult>
    <PayMode></PayMode>
...
<Risk>
	...
	<Mult><xsl:value-of select="LiAppdInsuNumb" /></Mult>
    <PayMode></PayMode>
	<PayIntv><xsl:value-of select="$PayIntv" /></PayIntv>
...
<xsl:choose>
	...
	<!-- 50002-安邦长寿稳赢1号两全保险组合:主险：122046 - 安邦长寿稳赢1号两全保险,附加险：122047 - 安邦附加长寿稳赢两全保险,122048 - 安邦长寿添利终身寿险（万能型） -->
	<!-- 50015-安邦长寿稳赢1号两全保险组合:主险：122046 - 安邦长寿稳赢1号两全保险,附加险：122047 - 安邦附加长寿稳赢两全保险,L12081 - 安邦长寿添利终身寿险（万能型） -->
	...
	<!-- add by duanjz 2015-10-20  增加 安邦长寿安享3号保险计划50011   end-->
	<!-- 安邦长寿6号两全保险（分红型） -->
	<!-- 
...
<xsl:choose>
	<!-- 50002-安邦长寿稳赢1号两全保险组合:主险：122046 - 安邦长寿稳赢1号两全保险,附加险：122047 - 安邦附加长寿稳赢两全保险 -->
	<!-- 50002-安邦长寿稳赢1号两全保险组合:主险：122046 - 安邦长寿稳赢1号两全保险,附加险：L12081 - 安邦附加长寿稳赢两全保险 -->
