...
public class CiticConf extends XmlConf {
	private static final CiticConf cThisIns = new CiticConf();
	
	private static final String cPath = "conf/citic.xml";
	...
	public void load() {
		cLogger.info("Into CiticConf.load()...");
		...
		cLogger.info("Out CiticConf.load()!");
	}
	
	public static CiticConf newInstance() {
		return cThisIns;
	}
}
