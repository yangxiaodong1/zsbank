...
public class IcbcZJConf extends XmlConf {
	private static final IcbcZJConf cThisIns = new IcbcZJConf();
	
	private static final String cPath = "conf/icbczj.xml";
	...
	public void load() {
		cLogger.info("Into IcbcZJConf.load()...");
		...
		cLogger.info("Out IcbcZJConf.load()!");
	}
	
	public static IcbcZJConf newInstance() {
		return cThisIns;
	}
}
