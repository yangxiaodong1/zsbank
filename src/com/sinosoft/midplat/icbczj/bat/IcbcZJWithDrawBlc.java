...
/**   
 * @Title: IcbcZJWithDrawBlc.java 
 * @Package com.sinosoft.midplat.icbczj.bat 
 * @Description: 浙江工行二期，提款对账交易。将银行报文进行格式转换。 
 * @date Dec 22, 2015 3:55:38 PM 
 * @version V1.0   
 */

public class IcbcZJWithDrawBlc extends Balance{
	
	public IcbcZJWithDrawBlc() {
		super(IcbcZJConf.newInstance(), "188");	// funFlag="188"-浙江工行提款对账
	}
	...
	protected Element parse(InputStream pBatIs) throws Exception {
		cLogger.info("Into IcbcZJWithDrawBlc.parse()...");
		...
		String sumLine = mBufReader.readLine();
		cLogger.info("江浙工行汇总行====" + sumLine);
		...
		for (String tLineMsg; null != (tLineMsg=mBufReader.readLine());) {
			...
			tTranMoneyEle.setText(String.valueOf(NumberUtil.yuanToFen(tSubMsgs[8])));
...
//			tAccNameEle.setText("");
		...
		cLogger.info("Out IcbcZJWithDrawBlc.parse()!");
		return mBodyEle;
	}
	...
	/** 
	 * 结果文件格式：
	 * ICBCZJ+保险公司代码(3位)+银行代码(01)+YYYYMMDD+TIKUAN.txt
	 * (non-Javadoc)
	...
	protected String getFileName() {
		...
		strBuf.append("ICBCZJ").append(mBankEle.getAttributeValue("insu"))
	...
	public static void main(String[] args) throws Exception{
		IcbcZJWithDrawBlc blc = new IcbcZJWithDrawBlc();
