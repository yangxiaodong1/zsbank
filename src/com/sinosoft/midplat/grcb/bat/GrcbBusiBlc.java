package com.sinosoft.midplat.grcb.bat;
...
import com.sinosoft.midplat.grcb.GrcbConf;



public class GrcbBusiBlc extends Balance {

	public GrcbBusiBlc() {
		super(GrcbConf.newInstance(), "3204");
	}
	...
	/**
	 *对账文件名：GZCB+日期+01.txt（例如：GZCB2015030101.txt）
	...
	protected Element parse(InputStream pBatIs) throws Exception {
		...
		cLogger.info("Into GrcbBusiBlc.parse()...");
...
//			tPremEle.setText(String.valueOf(tPremFen));
		...
		cLogger.info("Out GrcbBusiBlc.parse()!");
		return mBodyEle;
	}
