...
public class ContConfirm extends XmlSimpFormat {
	...
	public Document noStd2Std(Document pNoStdXml) throws Exception {
	    ...
	    mSqlStr.append("select ProposalPrtNo, ContNo, OtherNo from TranLog where Rcode = '0' and Funcflag = '3100' " +
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		if("50015".equals(tContPlanCode)){ 
			...
			cLogger.info("hbyh_河北银行，进入ContConfirmOutXsl50002进行报文转换，产品组合编码contPlanCode=[" + tContPlanCode + "]");
		}else{
			//按险种出单
			...
			cLogger.info("hbyh_河北银行，进入ContConfirmOutXsl进行报文转换，产品编码riskCode=[" + mainRiskCode + "]");
		}
