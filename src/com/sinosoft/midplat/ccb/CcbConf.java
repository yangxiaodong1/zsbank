...
public class CcbConf extends XmlConf {
	private static final CcbConf cThisIns = new CcbConf();
	
	private static final String cPath = "conf/ccb.xml";
	...
	public static CcbConf newInstance() {
		return cThisIns;
	}
}
