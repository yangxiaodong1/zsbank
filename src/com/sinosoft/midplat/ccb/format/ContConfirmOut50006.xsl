...
<Detail_List>
	...
	<Detail>
		...
		<BkDetail1><xsl:text>　　　    您购买的保险产品为《安邦长寿智赢1号年金保险计划》。安邦附加长寿智赢护理保险（万能型）为本公司</xsl:text></BkDetail1>
		<BkDetail1><xsl:text>　　　赠送保险，不向您收取保险费。若您在该附加险合同生效后三年内退保，本公司不退还该附加险合同项下的现</xsl:text></BkDetail1>
		<BkDetail1><xsl:text>　　　金价值。等值于主险首期保险费5%的金额将于附加险生效第一保单年度末最后一日24时注入附加险万能账户。</xsl:text></BkDetail1>
		<BkDetail1>　　　-------------------------------------------------------------------------------------------------</BkDetail1>
		<BkDetail1>
