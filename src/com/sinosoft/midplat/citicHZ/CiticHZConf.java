...
public class CiticHZConf extends XmlConf {
	private static final CiticHZConf cThisIns = new CiticHZConf();
	
	private static final String cPath = "conf/citichz.xml";
	...
	public void load() {
		cLogger.info("Into CiticHZConf.load()...");
		...
		cLogger.info("Out CiticHZConf.load()!");
	}
	
	public static CiticHZConf newInstance() {
		return cThisIns;
	}
}
