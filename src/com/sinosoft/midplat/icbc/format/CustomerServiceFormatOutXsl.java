 ...
 * @date   Mar 15, 2013
 */
public class CustomerServiceFormatOutXsl extends XslCache{

	private static CustomerServiceFormatOutXsl cThisIns = new CustomerServiceFormatOutXsl();

	private String cPath = "com/sinosoft/midplat/icbc/format/CustomerServiceFormatOut.xsl";
	
	public CustomerServiceFormatOutXsl() {
		load();
	...
	public static CustomerServiceFormatOutXsl newInstance() {
		return cThisIns;
	}
