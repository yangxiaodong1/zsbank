...
public class BjrcbConf extends XmlConf {
	private static final BjrcbConf cThisIns = new BjrcbConf();

	private static final String cPath = "conf/bjrcb.xml";
	...
	public void load() {
		cLogger.info("Into BjrcbConf.load()...");
		...
		cLogger.info("Out BjrcbConf.load()!");
	}

	public static BjrcbConf newInstance() {
		return cThisIns;
	}
}
