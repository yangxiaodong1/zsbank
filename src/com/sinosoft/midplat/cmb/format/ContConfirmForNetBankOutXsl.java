...
/**
 * @Title: com.sinosoft.midplat.cmb.format.ContConfirmForNetBankOutXsl.java
 * @Description: 加载招行网银签单报文格式转换文件，核心-->银行
 * Copyright: Copyright (c) 2014
 * Company:安邦保险IT部
 * 
 * @date Nov 19, 2014 5:53:33 PM
 * @version 
 *
 */
public class ContConfirmForNetBankOutXsl extends XslCache {
	...
	private String cPath = "com/sinosoft/midplat/cmb/format/ContConfirmForNetBankOut.xsl";
