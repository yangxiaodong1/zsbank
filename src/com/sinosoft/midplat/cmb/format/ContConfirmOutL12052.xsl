		...
		<OLife>
			...
			<OLifeExtension>
				...
				<CashValue>
						...
						<PrintInfo>　　　    等待期：保险合同生效（或最后复效）之日起180日（这180日的时间为等待期）内被保险人因疾病身故，</PrintInfo>
						<PrintInfo>　　　返还所交保费，保险合同终止。因意外伤害导致身故，无等待期，按照下述“身故保险金”的约定给予赔付。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　    生存年金：自满十个保单年度起至约定的生存年金领取期期满日止，如被保险人在此期间的每个保单年度</PrintInfo>
						<PrintInfo>　　　末之日仍生存，每年按照基本保险金额给付“生存年金”。生存年金领取期届满时，保险合同终止。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　    身故保险金：按照所交保险费与现金价值的较大者给付，保险合同终止。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
				        ...
				        <PrintInfo><xsl:text/>　　　保单年度末<xsl:text>                       </xsl:text><xsl:text>现金价值</xsl:text><xsl:text>                       </xsl:text><xsl:text>生存年金</xsl:text></PrintInfo>
						<xsl:for-each select="$MainRisk/CashValues/CashValue">
						<xsl:variable name="EndYear" select="EndYear"/>
						   <PrintInfo><xsl:text>　　　　　</xsl:text>
								...
								<xsl:choose>
									<xsl:when test="$EndYear &lt; 10">  --</xsl:when>
									<xsl:when test="$EndYear &gt;= 10"><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(concat(java:com.sinosoft.midplat.common.NumberUtil.fenToYuan(//Body/Amnt), '元'),0)"/></xsl:when>
						...
						<PrintInfo>　　　1.所列现金价值为对应保单年度末的值，保单年度内的现金价值，您可以向本公司咨询。</PrintInfo>
						<PrintInfo>　　　2.自满十个保单年度起至约定的生存年金领取期期满日止，如被保险人在此期间的每个保单年度末之日仍生存，</PrintInfo>
						<PrintInfo>　　　每年按照基本保险金额给付“生存年金”。生存年金领取期届满时，保险合同终止。</PrintInfo>
						<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
				</CashValue>				
				</BasePlanPrintInfos>
			</OLifeExtension>
