...
public class NewContForSelfTerm extends XmlSimpFormat {
	...
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		...
		Document mStdXml = NewContForSelfTermInXsl.newInstance().getCache().transform(pNoStdXml);
...
//		JdomUtil.print(pNoStdXml);
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		Document mNoStdXml = NewContForSelfTermOutXsl.newInstance().getCache().transform(pStdXml);
