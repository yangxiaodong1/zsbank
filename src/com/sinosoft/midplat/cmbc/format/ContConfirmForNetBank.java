...
public class ContConfirmForNetBank extends XmlSimpFormat {
	...
	public Document noStd2Std(Document pNoStdXml) throws Exception {
	    ...
	    mSqlStr.append("select ProposalPrtNo, ContNo, OtherNo,NodeNo from TranLog where Rcode = '0' and Funcflag = '3005' and ContNo = '"
...
//		mBodyEle.getChild(ContPrtNo).setText(mSSRS.GetText(1, 3));
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		if("50015".equals(tContPlanCode)){	// 50002产品升级，核心险种代码变为了50015
			mNoStdXml = ContConfirmForNetBankOutXsl50002.newInstance().getCache().transform(pStdXml);
		}
		else{
