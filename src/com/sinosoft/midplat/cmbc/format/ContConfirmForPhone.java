...
public class ContConfirmForPhone extends XmlSimpFormat {
	...
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into ContConfirmForPhone.noStd2Std()...");
	    ...
	    mSqlStr.append("select ProposalPrtNo, ContNo, OtherNo,NodeNo from TranLog where Rcode = '0' and Funcflag = '3007' and ContNo = '"
...
//	    		+ "' and OtherNo= '"+ mBodyEle.getChildText(ContPrtNo)
		...
		// 网银签单使用的网点以网银试算时记录的为准。--需求变更，以银行网点数据为准
...
//		mBodyEle.getChild(ContPrtNo).setText(mSSRS.GetText(1, 3));
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		cLogger.info("Into ContConfirmForPhone.Std2StdnoStd()...");
		...
		if("50015".equals(tContPlanCode)){	// 50002产品升级，核心险种代码变为了50015
			mNoStdXml = ContConfirmForPhoneOutXsl50002.newInstance().getCache().transform(pStdXml);
		}
		else{
		...
		cLogger.info("Out ContConfirmForPhone.Std2StdnoStd()!");
		return mNoStdXml;
	}
	...
	public static void main(String[] args) throws Exception {
        ...
        out.write(JdomUtil.toStringFmt(new ContConfirmForPhone(null).std2NoStd(doc)));
        out.close();
