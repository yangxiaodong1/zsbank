...
public class HrbcbConf extends XmlConf{

	private static final HrbcbConf cThisIns = new HrbcbConf();
	private static final String cPath = "conf/hrbcb.xml";
	...
	public void load() {
		...
		cLogger.info("Into HrbcbConf.load()...");
		...
		cLogger.info("Out HrbcbConf.load()!");
	}
	
	public static HrbcbConf newInstance() {
		return cThisIns;
	}
}
