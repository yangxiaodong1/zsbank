...
<xsl:template match="Body">
	...
	<Detail_List>
		...
		<Detail>
			...
			<Ret_Inf>　</Ret_Inf>
			<Ret_Inf>　</Ret_Inf>
			<Ret_Inf><xsl:text>　　　保险单号码：</xsl:text><xsl:value-of select="ContNo" />
			...
			<xsl:choose>
				...
				<xsl:otherwise>
					<Ret_Inf><xsl:text>　　　    《安邦长寿安享5号年金保险计划》由主险《安邦长寿安享5号年金保险》及附加险《安邦附加长寿添</xsl:text></Ret_Inf>
					<Ret_Inf><xsl:text>　　　利5号两全保险（万能型）》组成。经生存年金受益人同意后，主险产品的生存年金，在年金给付日自动</xsl:text></Ret_Inf>
					<Ret_Inf><xsl:text>　　　转入附加险万能账户中，享受日日复利，月月结息的资金增值服务。</xsl:text></Ret_Inf>
				</xsl:otherwise>
			</xsl:choose>
			<Ret_Inf>　　　-------------------------------------------------------------------------------------------------</Ret_Inf>
	...
	<xsl:if test="$MainRisk/CashValues/CashValue != ''">
	 <Detail_List>
		...
		<Detail>
			...
			<Ret_Inf>　</Ret_Inf>
			<Ret_Inf>　　　保险单号码：<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(ContNo, 60)"/>币值单位：人民币元 </Ret_Inf>
			<Ret_Inf>　　　------------------------------------------------------------------------------------------------</Ret_Inf>
			<Ret_Inf>　　　被保险人姓名：<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(Insured/Name,40)"/><xsl:text>险种名称：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_($MainRisk/RiskName, 0)"/></Ret_Inf>
			<Ret_Inf><xsl:text/>　　　保单年度末<xsl:text>       </xsl:text>
			   ...
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[9]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[10]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[11]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[12]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[13]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[14]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[15]/Cash)"/>元</Ret_Inf>
			   <Ret_Inf><xsl:text/><xsl:text>　　　　　 </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_($Cash8a,10)"/></Ret_Inf>
...
<xsl:template name="tran_ContPlanCode">
	...
	<xsl:choose>
		...
		<xsl:when test="$contPlanCode=50012">50012</xsl:when>	<!-- 安邦长寿稳赢保险计划（万能型） -->
		<xsl:otherwise>--</xsl:otherwise>
	</xsl:choose>
</xsl:template>
