...
<xsl:template match="Body">
	...
	<Busi_List>
		<xsl:for-each select="Risk[RiskCode=MainRiskCode]">
			<Busi_Detail>
				...
				<!-- 银行贷款合同编号 建行新一代2.2版本调整为 代理保险贷款合同编号
	...
	<!-- add 20150820 新一代2.2版本新增 红利实际发放日期 -->
	<XtraDvdn_Act_Dstr_Dt></XtraDvdn_Act_Dstr_Dt>
	<!-- add 20150820 新一代2.2版本新增 本期红利金额 -->
	<CrnPrd_XtDvdAmt></CrnPrd_XtDvdAmt>
	<!-- add 20150820 新一代2.2版本新增 终了红利金额 -->
	<ATEndOBns_Amt></ATEndOBns_Amt>
	<!-- add 20150820 新一代2.2版本新增 累积红利金额 -->
...
<xsl:template name="tran_Riskcode">
	...
	<xsl:choose>
		...
		<xsl:when test="$riskcode='122047'">122047</xsl:when>	<!-- 安邦长寿稳赢保险计划 -->
		<xsl:when test="$riskcode='L12081'">122048</xsl:when>	<!-- 安邦长寿稳赢保险计划 -->
		...
		<xsl:when test="$riskcode='L12070'">50012</xsl:when>	<!-- 安邦长寿稳赢保险计划 -->
		...
		<xsl:when test="$riskcode='122048'">122048</xsl:when>	<!-- 安邦长寿稳赢保险计划 -->
...
<xsl:template name="tran_ContPlanCode">
	...
	<xsl:choose>
		...
		<xsl:when test="$contPlanCode='50002'">50002</xsl:when>	<!-- 安邦长寿稳赢保险计划 -->
		<!-- add by duanjz 2015-7-6 PBKINSR-694 增加安享5号产品  begin -->
...
<xsl:template name="tran_Nationality">
	...
	<xsl:choose>
		...
		<xsl:when test="$nationality='AU'">36</xsl:when>	<!-- 澳大利亚 -->
