...
<Body>
	...
	<PrtList>
		...
		<PrtItem>
			...
			<xsl:choose>
				<xsl:when test="$MainRisk/CashValues/CashValue != ''">
					<Count>2</Count>
				</xsl:when>
				<xsl:otherwise>
					<Count>1</Count>
			...
			<PageItem>
				...
				<Remark></Remark></RowItem>
				<RowItem><RowId></RowId>
					<RowText><xsl:text>　　　保险单号码：</xsl:text><xsl:value-of select="ContNo" /><xsl:text>                                                    币值单位：人民币元</xsl:text></RowText>
				<Remark></Remark></RowItem>
				<RowItem><RowId></RowId>
					<RowText>　　　------------------------------------------------------------------------------------------------</RowText>
				<Remark></Remark></RowItem>
