		...
		<OLife>
			...
			<OLifeExtension>
				...
				<ContPrint>
					...
					<PrintInfo/>
					<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
					<PrintInfo>　　　<xsl:if test="Risk[RiskCode=MainRiskCode]/RiskType=2">分红保险红利领取方式：累积生息</xsl:if></PrintInfo>
					<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
				...
				<CashValue>
						...
						<PrintInfo>　　　    等待期：保险合同生效（或最后复效）之日起180日（这180日的时间称为等待期）内被保险人因疾病身故</PrintInfo>
						<PrintInfo>　　　或全残，返还所交保费的105%，保险合同终止。被保险人因意外伤害导致身故或全残，无等待期，按照下述“</PrintInfo>
						<PrintInfo>　　　身故或全残保险金”或“公共交通意外身故或全残保险金”的约定给予赔付。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　    身故或全残保险金：按照保险合同约定的基本保险金额给付，保险合同终止。</PrintInfo>
						<PrintInfo>　　　    公共交通意外身故或全残保险金：按照保险合同约定的基本保险金额的3倍（最高不超过已交保险费和200</PrintInfo>
						<PrintInfo>　　　万元之和）给付，保险合同终止。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　    满期保险金：按照保险合同约定的基本保险金额给付，保险合同终止。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　    每个保单年度可分享公司的经营成果，享有保单红利。具体的分红情况可从安邦人寿每个保单年度寄送的</PrintInfo>
						<PrintInfo>　　　红利通知书、官网（http://www.anbang-life.com）或官方微信（微信号:anbanglife）中查询。</PrintInfo>
						<PrintInfo/>
						<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
						...
						<PrintInfo>　　　被保险人姓名：<xsl:value-of select="Insured/Name"/></PrintInfo>
			 	        <PrintInfo>
					    <xsl:text>　　　产品名称：                  </xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_($MainRisk/RiskName,30)"/></PrintInfo>
						...
						<xsl:variable name="EndYear" select="EndYear"/>
						   <PrintInfo><xsl:text/><xsl:text>　　　　　</xsl:text>
						   							<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(EndYear,29)"/>
						   							<xsl:if test="$EndYear &lt; 5">
													...
													<xsl:choose>
														...
														<xsl:when test="$EndYear=3">除所列保单利益外，您每个保单年度还可分享公</xsl:when>
														<xsl:when test="$EndYear=4">司的经营成果，享有保单红利。</xsl:when>
														<xsl:otherwise></xsl:otherwise>
													</xsl:choose></PrintInfo>
				       </xsl:for-each>
						<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
						<PrintInfo></PrintInfo>
						<PrintInfo>　　　备注：</PrintInfo>
						<PrintInfo>　　　1.第1-4个保单年度末所列保单利益数值为保单的现金价值，是对应保单年度末的值，保单年度内的现金价值，</PrintInfo>
						<PrintInfo>　　　您可以向本公司咨询。</PrintInfo>
						<PrintInfo>　　　2.第5个保单年度末所列保单利益数值为保单的“满期保险金”，为保险合同约定的基本保险金额。</PrintInfo>
						<PrintInfo>　　　------------------------------------------------------------------------------------------------</PrintInfo>
				</CashValue>				
				</BasePlanPrintInfos>
			</OLifeExtension>
