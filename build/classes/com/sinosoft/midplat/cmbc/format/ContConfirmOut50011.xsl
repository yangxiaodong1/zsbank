	...
	<xsl:template name="TRAN_BODY" match="Body">
		...
		<Prnts>
			...
			<Page>
						...
						<Prnt><Value><xsl:text></xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(RiskName, 39)"/>
							...
							<xsl:choose>
								<xsl:when test="PayIntv = 0">
									<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('一次性', 13)"/>
								</xsl:when>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<Prnt><Value>   《安邦长寿安享3号年金保险计划》由主险《安邦长寿安享3号年金保险》及附加险《安邦附加长寿</Value></Prnt>
						<Prnt><Value>添利3号两全保险（万能型）》组成。经生存年金受益人同意后，主险产品的生存年金，在年金给付日</Value></Prnt>
				...
				<Prnt><Value><xsl:text>银行销售人员：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(TellerName,49)"/><xsl:text>从业资格证编号：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(TellerCertiCode,0)"/></Value></Prnt>
		...
		<Messages>
			...
			<Page>
				...
				<Message><Value>　　　-------------------------------------------------------------------------------------------------------------------------</Value></Message>
				<Message><Value><xsl:text>　　　被保险人姓名：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(Insured/Name,48)"/><xsl:text>险种名称：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_($MainRisk/RiskName,0)"/></Value></Message>
