	...
	<xsl:template match="Body">
		<App>
			<Ret>
                ...
                <Prnt3>　　　经投保人<xsl:value-of select="PubContInfo/AppntName" />申请，自<xsl:value-of select="$appDate" />起<xsl:value-of select="PubContInfo/ContNo" />号保险合同效力终止。</Prnt3>
                <Prnt4>　　　此变更自<xsl:value-of select="$appDate" />起生效。</Prnt4>
