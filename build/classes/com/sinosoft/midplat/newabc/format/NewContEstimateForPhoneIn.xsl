...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="App/Req">
		<Body>
			<!-- 农行网银的保费估算查询(网银)，在核心用来区分试算和网银保费估算查询的标示 （1标示-保费估算查询(网银)）-->
			<IsPremCal>1</IsPremCal>
			<!-- 投保基本信息 -->
	...
	<xsl:template match="Appl">
		<Appnt>
			...
			<!-- 职业代码 -->
			<JobCode>
				<xsl:value-of select="java:com.sinosoft.midplat.newabc.util.Trans_newabc.ToInsu_JobCode(AnnualIncome)" />
			</JobCode>
			<!-- 投保人年收入 -->
			<Salary>
				<xsl:value-of select="java:com.sinosoft.midplat.newabc.util.Trans_newabc.ToInsu_AnnualIncome(AnnualIncome)" />
			</Salary>
			<!-- 投保人家庭年收入-->
