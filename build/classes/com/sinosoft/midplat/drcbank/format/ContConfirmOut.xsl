	...
	<xsl:template name="Body" match="Body">
		<Body>
			...
			<PRINT>
				...
				<PRINT_LINE></PRINT_LINE>
				<PRINT_LINE></PRINT_LINE>
				<PRINT_LINE>　<xsl:if test="Risk[RiskCode=MainRiskCode]/RiskType='2'">分红保险红利领取方式：累积生息</xsl:if></PRINT_LINE>
				<PRINT_LINE>　------------------------------------------------------------------------------------------------</PRINT_LINE>
				...
				<PRINT_LINE></PRINT_LINE>
				<PRINT_LINE><xsl:text>　银行网点名称：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(AgentComName, 49)"/><xsl:text>银行销售人工号：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(SellerNo, 20)"/></PRINT_LINE>
				<PRINT_LINE><xsl:text>　银行销售人员：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(TellerName, 49)"/><xsl:text>业务资格证编号：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(TellerCertiCode, 20)"/></PRINT_LINE>
