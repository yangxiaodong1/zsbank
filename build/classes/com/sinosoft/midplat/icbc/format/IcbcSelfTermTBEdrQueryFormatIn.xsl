...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="Head" match="TXLifeRequest">
		<Head>
			<TranDate>
				<xsl:value-of select="java:com.sinosoft.midplat.common.DateUtil.date10to8(TransExeDate)" />
			</TranDate>
			<TranTime>
				<xsl:value-of select="java:com.sinosoft.midplat.common.DateUtil.time8to6(TransExeTime)" />
			</TranTime>
			<TellerNo>
	...
	<xsl:choose>
		...
		<!-- PBKINSR-739 工行，自助终端，盛世9号新产品开发需求 -->
