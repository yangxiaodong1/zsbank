		...
		<Print>
			...
			<SubVoucher>
				...
				<Text>
					...
					<TextContent>
						<TextRowContent>
							<xsl:text>　　　　　　　险种名称              保险期间    交费年期   基本保险金额\日    保险费    交费频率</xsl:text>
						</TextRowContent>
					</TextContent>
					<TextContent>
						<TextRowContent>
							<xsl:text>　　　　　　　                                             津贴额\份数\档次</xsl:text>
						</TextRowContent>
					</TextContent>
					<TextContent>
						<TextRowContent>
					...
					<TextContent>
						<TextRowContent>
							<xsl:text/>保险费合计：<xsl:value-of select="PremText"/>（RMB<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan(Prem)"/>元整）</TextRowContent>
					</TextContent>
					<TextContent>
						<TextRowContent/>
					</TextContent>
