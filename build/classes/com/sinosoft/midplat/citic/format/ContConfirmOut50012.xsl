...
<Detail_List>
	...
	<Detail>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<BkDetail1><xsl:text>　　　　　    《安邦长寿安享5号年金保险计划》由主险《安邦长寿安享5号年金保险》及附加险《安邦附加长寿添</xsl:text></BkDetail1>
				<BkDetail1><xsl:text>　　　　　利5号两全保险（万能型）》组成。经生存年金受益人同意后，主险产品的生存年金，在年金给付日自动</xsl:text></BkDetail1>
	...
	<Detail>
		...
		<BkDetail1><xsl:text/>　　　　　保单年度末<xsl:text>       </xsl:text>
			   ...
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[9]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[10]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[11]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[12]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[13]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[14]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan($MainRisk/CashValues/CashValue[15]/Cash)"/>元</BkDetail1>
			   <BkDetail1><xsl:text/><xsl:text>　　　　　    </xsl:text>
										...
										<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_($Cash8a,10)"/></BkDetail1>
