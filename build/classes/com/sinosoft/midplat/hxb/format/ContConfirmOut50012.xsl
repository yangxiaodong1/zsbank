...
<xsl:stylesheet version="1.0"
		...
		<FILE_LIST>
			...
			<PAGE_LIST>
				...
				<xsl:for-each select="Risk">
					...
					<BKDETAIL>　　　    《安邦长寿安享5号年金保险计划》由主险《安邦长寿安享5号年金保险》及附加险《安邦附加长寿添利5</BKDETAIL>
					<BKDETAIL>　　　号两全保险（万能型）》组成。经生存年金受益人同意后，主险产品的生存年金，在年金给付日自动转入附</BKDETAIL>
					<BKDETAIL>　　　加险万能账户中，享受日日复利，月月结息的资金增值服务。</BKDETAIL>
					<BKDETAIL>　　　-------------------------------------------------------------------------------------------------</BKDETAIL>
	...
	<xsl:template name="tran_risk">
		...
		<xsl:choose>
			...
			<xsl:when test="$riskcode='L12070'">L12070</xsl:when><!-- 主险：L12070 - 安邦长寿安享5号年金保险 -->
			<xsl:when test="$riskcode='L12071'">L12071</xsl:when><!-- 附加险：L12071 - 安邦附加长寿添利5号两全保险（万能型） -->	
			<xsl:otherwise>--</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
