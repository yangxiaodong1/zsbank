		...
		<TranData>
			...
			<Body>
				...
				<PubContInfo>
					...
					<PayMode></PayMode><!-- TODO 需要跟郝庆涛确认是否应该是核心默认 -->
					<!-- 收付费银行编号--><!--确认交易时为必填项-->
				...
				<ValiDate><xsl:value-of select="java:com.sinosoft.midplat.common.DateUtil.getCur6Time()"/></ValiDate>
			</Body>
		</TranData>
	</xsl:template>
